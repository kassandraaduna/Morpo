...
const styles = StyleSheet.create({
    ...
    pointsRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#F1F5F9' },
    pointsInput: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, borderWidth: 1, borderColor: '#E2E8F0', fontSize: 14, backgroundColor: '#F8FAFC', color: '#000', fontWeight: '900', width: 80, textAlign: 'center' },
