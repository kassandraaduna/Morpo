...
const localStyles = StyleSheet.create({
  ...
  greetText: { fontSize: 14, fontWeight: '500', color: 'rgba(255,255,255,0.6)' },
  userName: { fontSize: 22, fontWeight: '800', color: '#fff', marginTop: 2 },
  headerAvatar: { width: 50, height: 50, borderRadius: 25, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.4)' },
  initialsCircle: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' },
  ...
  statLabel: { fontSize: 8, fontWeight: '800', color: '#94A3B8', marginTop: 2 },

  contentBody: { paddingHorizontal: 22, marginTop: 25 },
  sectionLabel: { fontSize: 12, fontWeight: '900', color: '#153c2a', letterSpacing: 1.2, textTransform: 'uppercase', marginBottom: 18 },
  ...
  iconCircle: { width: 64, height: 64, backgroundColor: '#F0F9F4', borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginBottom: 10, elevation: 2 },
  ...
  rowAvatar: { width: 48, height: 48, borderRadius: 16, marginRight: 14 },
  rowInitialsCircle: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center', marginRight: 14 },
  rowInitialsText: { fontSize: 16, fontWeight: '800', color: '#64748B' },
  studentName: { fontSize: 14, fontWeight: '900' },
  studentMeta: { fontSize: 10, fontWeight: '600', color: '#94A3B8', marginTop: 3 },
  rowRight: { alignItems: 'flex-end' },
  percentText: { fontSize: 17, fontWeight: '900' },
  progressTrack: { width: 60, height: 5, backgroundColor: '#F1F5F9', borderRadius: 2.5, marginTop: 6 },
